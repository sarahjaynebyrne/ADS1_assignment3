...
axs12[0].scatter(df_comb2000['Human Development Index'],
                 df_comb2000['2000'],
                 color = 'indigo')
...
'''
# data from df_comb2000
axs12[1].scatter(df_comb2017['Human Development Index'],
                 df_comb2017['2017'],
                 color = 'indigo')
# predictive line from above
axs12[1].plot(x1, y1, 
...
'''
# set x-labels
axs12[0].set_xlabel('Human Development Index (2000)')
axs12[1].set_xlabel('Original Data')

# set y-labels
axs12[0].set_ylabel('Mortality Rate (2000)')
axs12[1].set_ylabel('Residuals')
