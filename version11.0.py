...
# set x-label
axs10[0,0].set_xlabel('Human Development Index in 2019', fontsize = 15)
axs10[1,0].set_xlabel('Human Development Index in 2019', fontsize = 15)
axs10[2,0].set_xlabel('Human Development Index in 2019', fontsize = 15)
axs10[3,0].set_xlabel('Human Development Index in 2019', fontsize = 15)
axs10[0,1].set_xlabel('Original Data', fontsize = 15)
axs10[1,1].set_xlabel('Original Data', fontsize = 15)
axs10[2,1].set_xlabel('Original Data', fontsize = 15)
axs10[3,1].set_xlabel('Original Data', fontsize = 15)
...
# set y-label
axs10[0,0].set_ylabel('Mortality Rates in 2019', fontsize = 15)
axs10[1,0].set_ylabel('Mortality Rates in 2019', fontsize = 15)
axs10[2,0].set_ylabel('Mortality Rates in 2019', fontsize = 15)
axs10[3,0].set_ylabel('Mortality Rates in 2019', fontsize = 15)
axs10[0,1].set_ylabel('Residuals', fontsize = 15)
axs10[1,1].set_ylabel('Residuals', fontsize = 15)
axs10[2,1].set_ylabel('Residuals', fontsize = 15)
axs10[3,1].set_ylabel('Residuals', fontsize = 15)
...
'''
to observe the fit on another year 
'''
w1 = df_comb2000['Human Development Index']
z1 = df_comb2000['2000']
# Calculate the residuals
res_poly5 = w1 - objective(z1, *pars4)

w2 = df_comb2017['Human Development Index']
z2 = df_comb2017['2017']
# Calculate the residuals
res_poly6 = w2 - objective(z2, *pars4)
...
# set x-labels
axs12[0,0].set_xlabel('Human Development Index (2000)', fontsize = 15)
axs12[0,1].set_xlabel('Original Data', fontsize = 15)
axs12[1,0].set_xlabel('Human Development Index (2017)', fontsize = 15)
axs12[1,1].set_xlabel('Original Data', fontsize = 15)

# set y-labels
axs12[0,0].set_ylabel('Mortality Rate (2000)', fontsize = 15)
axs12[1,0].set_ylabel('Mortality Rate (2017)', fontsize = 15)
axs12[0,1].set_ylabel('Residuals', fontsize = 15)
axs12[1,1].set_ylabel('Residuals', fontsize = 15)
...
axs13[0,0].scatter(new_df['Year'],
              new_df['Netherlands'], color = 'indigo')

# predictive model
axs13[0,1].plot(xnew, ynew1, color = 'magenta')
axs13[1,0].plot(xnew, ynew2, color = 'orange')
axs13[1,1].plot(xnew, ynew3, color = 'pink')
